...
export function createRemotePosApi(baseUrl: string, secret: string) {
  ...
  return {
    ...
    suppliers: {
      ...
      cancelPayment: inv('pos:suppliers:cancelPayment'),
      listAdvances: inv('pos:suppliers:listAdvances'),
      applyAdvance: inv('pos:suppliers:applyAdvance'),
      getSettlement: inv('pos:suppliers:getSettlement'),
      previewSettlement: inv('pos:suppliers:previewSettlement'),
      settle: inv('pos:suppliers:settle'),
