...
export default function EmployeeForm() {
  ...
  const loadEmployee = async (employeeId: string) => {
    try {
      ...
      if (employee) {
        ...
        // Load permissions from employee data if available
  ...
  const setDefaultPermissions = (role: string) => {
    ...
    if (role === 'admin') {
      ...
      // Manager has most permissions except settings
      ...
      // Cashier can view and add orders, view products and customers
    ...
    <div className="space-y-6">
      <PageBreadcrumb
        items={[
          ...
          { label: isEditMode ? 'Xodimni tahrirlash' : 'Yangi xodim qo\'shish', href: '#' },
        ]}
      />
      ...
      <form onSubmit={handleSubmit}>
        <Tabs defaultValue="basic" className="space-y-6">
              ...
              <CardContent className="space-y-6">
                ...
                {!isEditMode && (
                  <div className="border-t pt-6">
                    <h3 className="mb-4 text-lg font-semibold">Yangi parol o'rnatish</h3>
                    <div className="grid gap-6 xl:grid-cols-2">
                      <div className="space-y-2">
          ...
          <TabsContent value="permissions" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Kirish huquqlari</CardTitle>
                <p className="text-sm text-muted-foreground">
