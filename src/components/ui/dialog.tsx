...
type DialogContentProps = React.ComponentProps<typeof DialogPrimitive.Content> & {
  /** When true, do not render the dark overlay. Useful for nested/floating dialogs (e.g., in POS). */
  hideOverlay?: boolean;
  /** Optional className override for the overlay (only used when hideOverlay is false). */
