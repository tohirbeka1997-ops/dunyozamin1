...
exports.registerCustomersHandlers = registerCustomersHandlers;
const electron_1 = require("electron");
const customersRepo = __importStar(require("../db/customers.repo"));
function registerCustomersHandlers() {
    electron_1.ipcMain.handle('customers:list', async (_event, params) => {
        try {
    ...
    electron_1.ipcMain.handle('customers:get', async (_event, id) => {
        try {
    ...
    electron_1.ipcMain.handle('customers:create', async (_event, payload) => {
        try {
    ...
    electron_1.ipcMain.handle('customers:update', async (_event, payload) => {
        try {
