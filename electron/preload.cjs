...
contextBridge.exposeInMainWorld('posApi', {
  ...
  customers: {
    ...
    applyAdvanceToOrder: (payload) => invoke('pos:customers:applyAdvanceToOrder', payload),
  ...
  suppliers: {
    ...
    getSettlement: (supplierId) => invoke('pos:suppliers:getSettlement', supplierId),
    previewSettlement: (payload) => invoke('pos:suppliers:previewSettlement', payload),
    settle: (payload) => invoke('pos:suppliers:settle', payload),
  ...
  reports: {
    ...
    financialActSverka: (filters) => invoke('pos:reports:financialActSverka', filters),
