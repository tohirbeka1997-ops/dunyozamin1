...
module.exports = {
  POS_CHANNELS: [
    ...
    'pos:customers:applyAdvanceToOrder',
    ...
    'pos:suppliers:cancelPayment',
    'pos:suppliers:listAdvances',
    'pos:suppliers:applyAdvance',
    'pos:suppliers:getSettlement',
    'pos:suppliers:previewSettlement',
    'pos:suppliers:settle',
