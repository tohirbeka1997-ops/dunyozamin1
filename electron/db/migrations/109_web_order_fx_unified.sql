-- Web order FX snapshot + unified sales view uses exchange_rates when fx_rate is NULL.
-- Columns are added via migrate.cjs safeAddColumn. This file recreates unified views.
